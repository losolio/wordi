...
1. Upload `wordi.php` to the `/wp-content/plugins/` directory
...
= 1.0 =
Upgrade words describe the reason a user should upgrade.  No more than 300 characters.
